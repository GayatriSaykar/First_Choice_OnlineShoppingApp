            ...
            <form>
                    <h2 style={{textAlign:'center'}}>Login</h2>
                        <div className="mb-3">
                            ...
                            <input type="text" name="cust_email" className="form-control" onChange={(e)=>{handleChange("cust_email",e.target.value)}} 
                            onBlur={(e)=>{handleChange("cust_email",e.target.value)}}/>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="cust_password" className="form-label">Enter Password:</label>
                            <input type="password" name="cust_password" className="form-control" onChange={(e)=>{handleChange("cust_password",e.target.value)}} 
                        ...
                        <Link to ="/password" className="navbar-brand"style={{color:"blue",textAlign:"left"}}></Link>
